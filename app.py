...
app.config['MAIL_PASSWORD'] = '5800'  # Replace with Gmail app password
...
def utility_processor():
    def get_image_path(filename):
        ...
        return path if os.path.exists(os.path.join(app.root_path, path)) else "static/images/default.jpg"
